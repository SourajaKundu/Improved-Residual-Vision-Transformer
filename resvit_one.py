...
class ResViT_model(BaseModel):
    ...
    def initialize(self, opt):
        ...
        if self.isTrain:
            ...
            #alpha = 1
            #self.gdl_loss = networks.GDLLoss(alpha)
            self.feat_loss = networks.FeatureLoss()
    ...
    def backward_G(self):
        ...
        #self.loss_G_GDL = self.gdl_loss(self.fake_B, self.real_B)*0.000005
        #self.loss_G = self.loss_G_GAN + self.loss_G_L1*1 + self.loss_G_GDL
        self.loss_G_feat = self.feat_loss(self.real_A, self.real_B, self.fake_B)*0.0001
        self.loss_G = self.loss_G_GAN + self.loss_G_L1*1 + self.loss_G_feat
